package com.basheyev.operatio.model.production;
...
public class Production implements JSONSerializable {
    ...
    private void startNewGame() {
        ...
        // Place starter blocks for new game
        ...
        // add material to inventory (steel)
        Item item;
        for (int i=0; i<60; i++) {
    ...
    public long getCycleMilliseconds() {
        return cycleMilliseconds;
    }

    public void setCycleMilliseconds(long cycleMilliseconds) {
