package com.basheyev.atom.engine.core;

import android.util.Log;
import android.view.MotionEvent;

import com.basheyev.atom.engine.data.events.GameEvent;
import com.basheyev.atom.engine.data.events.GameEventQueue;
...
public class GameLoop extends Thread {
    ...
    protected void gameCycle() {
        ...
        processInputEvent(scene);     // Вызываем обработчик событий ввода
        gameEvents.processEvent();    // Вызываем обработчик игровых событий
        deltaTime = (System.nanoTime() - lastCycleTime) / 1_000_000_000f;
        scene.updateScene(deltaTime); // Вызываем обновление сцены
        lastCycleTime = System.nanoTime();
    }
